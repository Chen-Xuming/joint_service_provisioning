...
# algorithm_in_fig = ["Nearest-RA", "M-Greedy-RA", "M-Greedy-V2-RA", "Min-Max-RASP"]

algorithm_list = ["Ours", "Ours_centralized"]
algorithm_in_fig = ["Min-Max-RASP", "Min-Max-RASP-Collocating"]
...
if __name__ == '__main__':
    ...
    if eta == 0:
        algorithm_list = ["Nearest", "M-Greedy", "M-Greedy-V2(Tx+Tp+Tq)", "Ours"]
        algorithm_in_fig = ["Nearest", "M-Greedy", "M-Greedy-V2", "Min-Max-RASP"]
