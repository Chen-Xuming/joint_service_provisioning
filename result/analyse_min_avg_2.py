        ...
        while eta <= eta_range[1]:
            ...
            for user_num in range(user_range[0], user_range[1] + user_step, user_step):
                ...
                for alg in algorithm_list:
                    ...
                    data[eta][user_num][alg]["avg_delay"].extend(data_each_alg["avg_delay"])
    ...
    while eta <= eta_range[1]:
        ...
        for user_num in range(user_range[0], user_range[1] + user_step, user_step):
            ...
            for alg in algorithm_list:
                ...
                data[eta][user_num][alg]["avg_delay"] = np.mean(data[eta][user_num][alg]["avg_delay"])
...
"""
def get_reduction_ratio(res_dict, attribute: str):
    reduction_ratios = {}
    original_algorithm = "Modify-Assignment-V2"
    target_algorithm = "RA-UA"
...
if __name__ == '__main__':
    file_dir = "min_avg/10-24_eta0.25-1.0_offload_dist_ma-v2"
