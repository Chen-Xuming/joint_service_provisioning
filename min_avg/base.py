...
class BaseMinAvgAlgorithm:
    ...
    def get_avg_delay(self):
        self.avg_delay = self.env.compute_avg_interactive_delay()

    def get_final_avg_cost(self):
        self.final_avg_cost = self.env.compute_cost()

    def get_target_value(self):
        self.target_value, self.avg_delay, self.final_avg_cost = self.env.compute_target_function_value("min-avg")
