...
""" 创建文件夹 """
description = "minmax-7algs"        # fixme
res_dir = "../../result/min_max/11-07_eta{}-{}_{}".format(eta_range[0], eta_range[1], description)
import os
        ...
        for i in range(simulation_times_each_num_user):
            ...
            for j, alg_name in enumerate(algorithms):
                ...
                if alg_name == "Min-Avg":
                    ...
                    min_avg_alg.run()
                    result_each_eta[num_user][alg_name]["max_delay"].append(min_avg_alg.max_delay)
                    result_each_eta[num_user][alg_name]["avg_cost"].append(min_avg_alg.final_avg_cost)
                    result_each_eta[num_user][alg_name]["target_value"].append(min_avg_alg.target_value)
                    result_each_eta[num_user][alg_name]["running_time"].append(min_avg_alg.running_time)
                    result_each_eta[num_user][alg_name]["local_count"].append(min_avg_alg.local_count)
                    result_each_eta[num_user][alg_name]["common_count"].append(min_avg_alg.common_count)
